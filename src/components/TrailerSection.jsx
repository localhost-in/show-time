...
const TrailerSection = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        <p className='text-gray-300 font-medium text0lg max-w-[960px] mx-auto'>Trailers</p>
        ...
        <div className='group grid grid-cols-4 gtap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
          {
            dummyTrailers.map((trailer)=>(
              <div key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:-translate-y-1 
              duration-300 transtition max-md:h-60 md:max-h-60 cursor-pointer' onClick={()=>
